...
bool InitializeGeometry(MyGeometry *geometry, float offset)
{
...
int main(int argc, char *argv[])
{
	...
	MyGeometry geometry1, geometry2;
	if (!InitializeGeometry(&geometry1, -.4f))
		cout << "Program failed to intialize geometry!" << endl;
	if (!InitializeGeometry(&geometry2, .4f))
		cout << "Program failed to intialize geometry!" << endl;

		MyTexture t1, t2;
		InitializeTexture(&t1, "img1.png");
		InitializeTexture(&t2, "img2.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		RenderScene(&geometry1, &shader, &t1);
		RenderScene(&geometry2, &shader, &t2);
	...
	DestroyGeometry(&geometry1);
	DestroyGeometry(&geometry2);
