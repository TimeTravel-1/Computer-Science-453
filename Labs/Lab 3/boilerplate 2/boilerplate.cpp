...
// Scale matrix
	...
	//uniform to update, how many to update, pointer to data 
	glUniformMatrix2fv(scaleUniform, 1, GL_TRUE, scaleMat);
...
// ==========================================================================
	...
	glUseProgram(shader.program);//uniform to update, how many to update, pointer to data 
	glUniformMatrix2fv(scaleUniform, 1, GL_TRUE, scaleMat);
